...
cmake \
 ...
 \
  -DUSE_CUDA:BOOL=ON \
  -DCUDA_NVCC_FLAGS:STRING="${COMPILER_FLAG}${COMPILER_FLAGS_HOST}${DEBUG_FLAG}-I${MPI_INCLUDE_DIR};-gencode;arch=compute_60,code=sm_60;-O3;-use_fast_math;--maxrregcount;128;-Xptxas=-v" \
  -DCUDA_HOST_COMPILER:STRING=clang \
